...
var star,star2,star_img, star_img1, star_img2;
var empty_star,star_display;


var blower, blower_img;
...
function preload()
{
  ...
  star_img1= loadImage('one_star.png');
  star_img2 = loadImage('stars.png');
...
function setup() 
{
 ...
 star_display = createSprite(65,20,30,30);
 star_display.addImage(empty_star);
 star_display.scale = 0.2;
star_display.addImage('empty' ,empty_star);
star_display.addImage('one' ,star_img1);
star_display.addImage('two' ,star_img2);
